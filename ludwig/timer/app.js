...
const getViewerCount = async () => {
    ...
    const response = await fetch('https://thingproxy.freeboard.io/fetch/http://tmi.twitch.tv/group/user/ludwig?nochache='+Math.floor(Math.random()*10000), {headers:{"Mode":"cors","Content-Type":"application/json","Accept":"application/json","Origin":origin}});
